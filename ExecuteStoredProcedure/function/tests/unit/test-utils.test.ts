...
describe("Build params", () => {
    ...
    it('Should build string with params and both ids', () => {
        const expected = `"test", 1, 1, @Rcode, @Rmessage`;
